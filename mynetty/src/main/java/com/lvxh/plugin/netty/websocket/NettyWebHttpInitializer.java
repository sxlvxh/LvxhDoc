...
public class NettyWebHttpInitializer extends ChannelInitializer<SocketChannel> {

	private static final Logger LOG = Logger.getLogger(NettyWebHttpInitializer.class);
