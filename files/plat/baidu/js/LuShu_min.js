...
(function () {
	...
	d.prototype.initialize = function (e) {
		var f = this._div = a.dom.create("div", {
				style : "border:solid 1px #07e4d6;width:auto;min-width:50px;text-align:center;position:absolute;background:#397296;color:#fff;font-size:12px;border-radius: 10px;padding:5px;white-space: nowrap;box-shadow: inset 0px 0px 15px rgb(8,246,229);"
			});
	...
	a.object.extend(d.prototype, {
		setPosition : function (h, i) {
			...
			this._div.style.bottom =  - (f.y - i.height+30) + "px"
		},
		setHtml : function (e) {
