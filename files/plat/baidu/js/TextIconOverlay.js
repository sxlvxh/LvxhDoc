...
(function () { 
    ...
    var TextIconOverlay = 
        ...
        */
        BMapLib.TextIconOverlay = function(position, text, options, data){
    ...
    */
    TextIconOverlay.prototype._updateText = function(){
        if (this._domElement) {
        	if(this._data){
        		var wpx = this._domElement.style.width;
        		var hpx = this._domElement.style.height;
        		var h = parseInt(hpx.replace("px",""),10);
        		//var lineH = parseInt(this._domElement.style.lineHeight.replace("px",""),10);
        		//console.log("===_updateText===",this._data,this.getStyleByText(this._text, this._styles));
        		//console.log(this._domElement.style,lineH);
        		var content = "<div style='width:"+wpx+";height:"+hpx+";padding:"+(h-35)/2+"px 0px;' data-params="+JSON.stringify(this._data)+">";
        		content += "<div style='line-height:15px;'>"+this._text+"</div>";
				if(this._data.name != undefined){
					content += "<div style='line-height:15px;'>"+this._data.name+"</div>";
				}
        		content += "</div>";
