...
(function (root, doc, factory) {
    ...
    $.fn.esign = function(canvasEdit, sign_show, sign_clear,sign_clear2, sign_ok) {

        //初始化相关DOM，获得结果寄存命名空间
        var domMap = domInit(canvasEdit, sign_show, sign_clear,sign_clear2, sign_ok);
        //获取画板引用
        ...
        domMap.sign_clear2.click(function(){
        ...
        */
        ...
        function domInit(canvasEdit, sign_show, sign_clear,sign_clear2 ,sign_ok){
            var domMap = {};
          ...
          if(!sign_clear2){
                ...
                domMap.sign_clear2 = $("#sign_clear2");
            } else{
                domMap.sign_clear2 = $("#" + sign_clear2);
            }
