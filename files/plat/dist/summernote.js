...
(function (factory) {
  ...
  var editable = renderer.create('<div class="note-editable panel-body" id="text-idit" style="word-break:break-all" contentEditable="true"/>');
  ...
  var Codeview = function (context) {
    ...
    this.activate = function () {
      ...
      $codable.height($editable.height());
   	...
   	var htmlconytent=$(".note-codable").val().replace('<br>','')
    var htmlconytentremovep=htmlconytent.replace('</p>','')
    var htmlconytentremove=htmlconytentremovep.replace('<p>','')
    
/*alert($(".note-editable p").height())*/
	var htmlcomplete="<!DOCTYPE html> "+"<html lang='en'>"+"<head>"+" <meta charset='UTF-8'>"
	+"</head>"+"<body>"+htmlconytent+"</body>"+"</html>"
	window.saveNoteFunc(htmlconytent);
	
      $codable.display("none")
  ...
  var HelpDialog = function (context) {
    ...
    this.showHelpDialog = function () {
     return $.Deferred(function (deferred) {
    	...
    	/*var htcontent= $(".panel-body >").html().replace('<br>','')*/	
