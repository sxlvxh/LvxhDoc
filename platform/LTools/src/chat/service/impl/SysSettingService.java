...
@Service
public class SysSettingService implements MenuEventService {

	private final static Logger LOG = Logger.getLogger(SysSettingService.class);
	
	@Override
	public void executor(MainController controller, MenuBean mneu) {
		Parent root;
		try {
			root = FXMLLoader.load(SettingController.class.getResource("setting.fxml"));
