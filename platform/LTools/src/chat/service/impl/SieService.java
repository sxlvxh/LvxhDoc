...
@Service
public class SieService implements MenuEventService {

	private final static Logger LOG = Logger.getLogger(SieService.class);
	
	@Override
	public void executor(MainController controller, MenuBean mneu) {
		Parent root;
		try {
			root = FXMLLoader.load(SieController.class.getResource("sie.fxml"));
