...
@Service
public class JstService implements MenuEventService {

	private final static Logger LOG = Logger.getLogger(JstService.class);
	
	@Override
	public void executor(MainController controller, MenuBean mneu) {
		Parent root;
		try {
			root = FXMLLoader.load(JstController.class.getResource("jst.fxml"));
