...
public class MySystemTray {
	...
	private final static Logger LOG = Logger.getLogger(MySystemTray.class);
    ...
    static{
        ...
        URL url = MySystemTray.class.getResource("animal_owl_48px_12156_easyicon.net.png");
    ...
    public void listen(Stage stage){
        //防止报空指针异常
        if(showListener == null || exitListener == null || mouseListener == null  || exitItem == null || trayIcon == null){
            return;
        }
        //移除原来的事件
