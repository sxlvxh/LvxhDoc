...
import com.huaiye.plugin.portal.business.holder.BaseBusinessHolder;
...
<#if column.javaName?lower_case = "id">
	...
	@JsonSerialize(using = com.huaiye.plugin.portal.common.system.CustomDateSerializer.class, include=JsonSerialize.Inclusion.NON_NULL)
	 ...
	 */
	<#if column.javaType = "java.util.Date">
	@JsonDeserialize(using = com.huaiye.plugin.portal.common.system.CustomDateDeserializer.class)
    </#if>
