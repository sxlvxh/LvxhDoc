...
public class JsonUtils {
	...
	public static final Gson gsonToUnderlineCase = new GsonBuilder().setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES)
            .registerTypeAdapter(Date.class, new ImprovedDateTypeAdapter()).create();
	...
	public static class JsonUtilTypeToken<T>{
        final Type type;

        protected JsonUtilTypeToken() {
            this.type = getSuperclassTypeParameter(getClass());
        }

        public T fromJsonUseTypeToken(String json) {
